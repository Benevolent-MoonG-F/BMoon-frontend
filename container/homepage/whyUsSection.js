        ...
        <Element name="whyUsSection" >
            {/* <div className={styles.container}>
                ...
                <div className={styles.content}> 
                    ...
                    <Benefit
                        title = ""
                        discription = "Benevolent Organizations that benefit from our community efforts include UNICEFUSA, Lustgarten Foundation, The Water Project, Free Code Camp, Angel Protocol and more. While other predictive market games benefit only the users, our goal is to benefit users and create a palpable social impact on the world. "
                    />
                </div>
            </div> */}
        </Element>
